...
class Daata_Decorations():
    ...
    def Cancel_booking(self):
        ...
        bill_entry=Entry(self.cancel_book, width=16,font=(25)).place(x=500, y=35)
    ...
    def setting(self):
        ...
        self.lawn__charges_spin = Spinbox(self.t1,textvariable=self.decoration, from_ = 0, to =9999, increment=50, width=5,font=(15))
        self.lawn__charges_spin.place(x=250, y=105)
        self.lbl=Label(self.t1, text="Gate + Stage:", font=('Arail', 15, 'bold'), bg='white').place(x=30, y=150)
        self.lawn__charges_spin = Spinbox(self.t1,textvariable=self.gate, from_ = 0, to =9999, increment=50, width=5,font=(15))
        self.lawn__charges_spin.place(x=250, y=155)
        self.lbl=Label(self.t1, text="Watchman:", font=('Arail', 15, 'bold'), bg='white').place(x=30, y=200)
        self.lawn__charges_spin = Spinbox(self.t1,textvariable=self.watchme, from_ = 0, to =9999, increment=50, width=5,font=(15))
        self.lawn__charges_spin.place(x=250, y=205)
        self.lbl=Label(self.t1, text="No.:", font=('Arail', 15, 'bold'), bg='white').place(x=350, y=200)
        self.lawn__charges_spin = Spinbox(self.t1,textvariable=self.no, from_ = 0, to =9999, increment=1, width=5,font=(15))
        self.lawn__charges_spin.place(x=450, y=205)
        self.lbl=Label(self.t1, text="Cleaning Charges:", font=('Arail', 15, 'bold'), bg='white').place(x=30, y=250)
        self.lawn__charges_spin = Spinbox(self.t1,textvariable=self.cleaning, from_ = 0, to =9999, increment=50, width=5,font=(15))
        self.lawn__charges_spin.place(x=250, y=255)
        self.lbl=Label(self.t1, text="Electric Charges:", font=('Arail', 15, 'bold'), bg='white').place(x=30, y=300)
        self.lawn__charges_spin = Spinbox(self.t1,textvariable=self.electric, from_ = 0, to =9999, increment=50, width=5,font=(15))
        self.lawn__charges_spin.place(x=250, y=305)
        self.lbl=Label(self.t1, text="Water Charges:", font=('Arail', 15, 'bold'), bg='white').place(x=30, y=350)
        self.lawn__charges_spin = Spinbox(self.t1,textvariable=self.water, from_ = 0, to =9999, increment=50, width=5,font=(15))
        self.lawn__charges_spin.place(x=250, y=355)
        ...
        self.Update_button=Button(self.t1, text='Update',bg='Green',fg='White',height=2, width=15,font=('arial', 10, 'bold'))
    ...
    def __init__(self):
        ...
        self.tree_note=ttk.Treeview(self.main_window, columns=self.column_notice, show='headings', height=24)
        ...
        self.tree_note.column('#4',anchor=CENTER, width=95)
        ...
        self.tree_note.column('#9',anchor=CENTER, width=85)
