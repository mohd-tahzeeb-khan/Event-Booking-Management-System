...
class Daata_Decorations():
    ...
    def Cancel_booking(self):
        ...
        column_notice=('#1','#2','#3','#4','#5')
        tree_note=ttk.Treeview(cancel_book, columns=column_notice, show='headings', height=27)
        tree_note.column('#1',anchor=CENTER, width=100)
        tree_note.column('#2',anchor=CENTER, width=120)
        tree_note.column('#3',anchor=CENTER, width=270)
        tree_note.column('#4',anchor=CENTER, width=110)
        tree_note.column('#5',anchor=CENTER, width=100)  
        tree_note.heading('#1', text='Bill No')
        tree_note.heading('#2', text='Booking Date')
        tree_note.heading('#3', text='Party Name')
        tree_note.heading('#4', text='Phone No')
        tree_note.heading('#5', text='Advance')
        tree_note.bind('<<TreeviewSelect>>')
        tree_note.place(x=30, y=120)
    ...
    def working_staff(self):
        working_staff=tk.Tk()
        working_staff.geometry('800x780')
        ...
        main_frame=Frame(working_staff, width=730, height=510, bg='white', relief=RIDGE, bd=5).place(x=35, y=145)
        btn_frame=Frame(working_staff, width=730, height=100, bg='white', relief=RIDGE, bd=5).place(x=35, y=655)
        ...
        tree_note=ttk.Treeview(working_staff, columns=column_notice, show='headings', height=23)
        tree_note.column('#1',anchor=CENTER, width=270)
        tree_note.column('#2',anchor=CENTER, width=110)
        tree_note.column('#3',anchor=CENTER, width=200)
        tree_note.column('#4',anchor=CENTER, width=100)
        tree_note.heading('#1', text='Name')
        tree_note.heading('#2', text='Work')
        tree_note.heading('#3', text='Phone No')
        tree_note.heading('#4', text='Salary')
        tree_note.bind('<<TreeviewSelect>>')
        tree_note.place(x=45, y=155)
